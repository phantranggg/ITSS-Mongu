...
product_features = [
    ...
    [3,'L','#FFFFFF',0,200000,5],
    [3,'M','#000000',0,300000,5],
    [3,'L','#000000',0,400000,5],
    [3,'M','#FFFFFF',1,500000,5],
    [3,'L','#FFFFFF',1,600000,5],
    [3,'M','#000000',1,700000,5],
    [3,'L','#000000',1,800000,5],
    
    [4,'M','#FFFFFF',0,800000,5],
    [4,'L','#FFFFFF',0,700000,5],
    [4,'M','#000000',0,600000,5],
    [4,'L','#000000',0,500000,5],
    [4,'M','#FFFFFF',1,400000,5],
    [4,'L','#FFFFFF',1,300000,5],
    [4,'M','#000000',1,200000,5],
